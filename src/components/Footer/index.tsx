      ...
      <footer aria-label="Site Footer" className="bg-gray-100">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 text-xs">
            ...
            is recognized by UNESCO. AIESEC International is registered as a
            Foundation (Stichting), RSIN #807103895 in Rotterdam, The
            Netherlands.
          </p>
          ...
          <ul className="mt-12 flex justify-center gap-6 md:gap-8">
            <li>
              <Link
                href="https://www.facebook.com/AIESECMorocco"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75"
              >
            ...
            <li>
              <Link
                href="https://www.instagram.com/aiesecmorocco/"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75"
              >
            ...
            <li>
              <Link
                href="https://www.linkedin.com/company/aiesecmorocco/"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75"
              >
                <LinkedIn />
